...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-teal-900 z-50">
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          ...
          <div id="contact">
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
              ...
              <li className="mb-4">
                <a className="hover:underline">Email: xyz@gmail.com</a>
              </li>
              <li className="mb-4">
        ...
        <div className="px-4 py-6 bg-gray-100 dark:bg-teal-700 md:flex md:items-center md:justify-between">
          <span className="text-sm text-emerald-300  sm:text-center">
            © 2024 <a>Bon Appetit™</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
            <a className="text-emerald-400  dark:hover:text-white">
              <svg
                className="w-4 h-4"
                aria-hidden="true"
